...
*** Contents Attribute List ***
   ...
   button | X | "확인","종료","취소","재시도" <br>등 사용자 정의   | code별 버튼 동작은 아래 spec 참고 <br> Custom 동작은 협의 필요


*** Predefined code & message ***

| No| code  | message_main | button | button Action | 실패 Action |
|---| :---: | -------------| ---| ---------- | ---------- |
| 1 | 0000  | 사용자 정의   | "확인" | 종료하고 Main으로 이동 | |
| 2 | 0001  | 사용자 정의   | "재시도"<br>"종료 혹은 취소" | 재시도 : 실패한 동작 재시고<br> 종료 : 종료하고 Main으로 이동 | |
| 3 | 0002  | 사용자 정의   | "종료"/"취소" | 종료하고 Main으로 이동 | |
| 4 | H0001 |	출근 등록이 정상적으로 완료되었습니다 | | | |
| 5 | H0002 |	퇴근 등록이 정상적으로 완료되었습니다 |	| | |
| 6 | H0003 |	출근 등록이 완료된 상태입니다	 	| | | |
| 7 | H0004 |	퇴근 등록이 완료된 상태입니다 	| | | |
| 8 | H0005 |	출근 등록이 완료되지 않았습니다  | | | |
| 9 | H0006 |	퇴근 등록이 완료되지 않았습니다  | | | |
| 10 | M0001 | 로그인이 완료 되었습니다 | | 종료하고 Main으로 이동 | |
