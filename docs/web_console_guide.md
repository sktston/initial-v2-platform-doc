...
기존 서버를 재사용 하기 위해서 발급을 일시 중지 합니다.(발급 기관만 해당됩니다)

- initial 관리자측에 요청하여 기존 기관의 App 노출 비활성화를 요청
- 발급 서버 가동 중지
...
-  Web Console 로그인 - 기관관리 - 기관정보에서 Console 공개 및 기관 활성화 하기
...
- initial 관리자측에 요청하여 신규 기관의 App 노출 활성화 합니다.
- intitial admin에서 노출에 대한 설정 권한을 가지고 있습니다.
